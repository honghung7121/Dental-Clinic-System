<%-- 
    Document   : footer
    Created on : Jun 8, 2023, 4:32:45 PM
    Author     : Admin
--%>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Dịch vụ
                            của chúng tôi</a>
                        <a class="text-light" href="https://www.facebook.com/profile.php?id=100076925937442"><i class="bi bi-arrow-right text-primary me-2"></i>Liên hệ chúng
                            tôi</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white border-bottom" href="#"> 2023. DentCare Clinic</a></p>
                </div>
