                ...
                <div class="row g-5 pt-4">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Trang
                                Chủ</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Về Chúng
                                Tôi</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Dịch vụ
                                của chúng tôi</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Blog mới
                                nhất</a>
                            <a class="text-light" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Liên hệ chúng
                                tôi</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
