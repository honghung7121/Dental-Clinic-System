...
public class EditDentistController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean check = false;
            Dentist den = DentistDAO.geDentistByID(id);
            String[] denOld = {den.getImg(), String.valueOf(den.getExperience()), den.getDegree()};
            ...
            check = DentistDAO.updateDentist(Integer.parseInt(id), fullname, phone, email, denNew[2], Integer.parseInt(denNew[1]), denNew[0], status);
