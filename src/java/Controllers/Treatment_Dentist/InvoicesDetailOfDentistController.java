 ...
 * @author Admin
 */
public class InvoicesDetailOfDentistController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<TreatmentCourseDetail> slist = sdao.getInvoicesDetailByTreatmentID(idTreatment);
