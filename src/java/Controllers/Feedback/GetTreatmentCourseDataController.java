 ...
 * @author Admin
 */
public class GetTreatmentCourseDataController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int dentistId = treatmentCourseDAO.getDentistByTreatmentCourseID(treatmentCourseDetailID);
            DentistDAO dentistDAO = new DentistDAO();
            Dentist dentist = dentistDAO.getDentistByID(Integer.toString(dentistId));
            int serviceid = treatmentCourseDAO.getServiceByTreatmentCourseID(treatmentCourseDetailID);
