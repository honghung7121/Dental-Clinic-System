 ...
 * @author Admin
 */
public class MarketingLoadMoreDentistController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Dentist dentist : list) {
            out.println("<div class=\"dentistProduct col-md-4 col-sm-4  col-lg-3\">\n"
                    ...
                    + "                                        <a class=\"avatar\" href=\"MainController?action=MarketingdentistProfile&dentistID=" + dentist.getId() + "\"><img alt=\"\" src=\"" + dentist.getImg() + "\"></a>\n"
                    + "                                    </div>\n"
                    ...
                    + "                                        </div>\n"
                    + "                                    </div>\n"
                    + "                                    <h4 class=\"doctor-name text-ellipsis\"><a href=\"MainController?action=MarketingdentistProfile&dentistID=" + dentist.getId() + "\">" + dentist.getFullName() + "</a></h4>\n"
