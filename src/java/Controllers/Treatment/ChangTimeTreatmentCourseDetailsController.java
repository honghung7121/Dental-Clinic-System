 ...
 * @author Admin
 */
public class ChangTimeTreatmentCourseDetailsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int id = Integer.parseInt(request.getParameter("treatmentCourseDetailID"));
            final Date date = Date.valueOf(request.getParameter("dateSelected"));
            final Time time = Time.valueOf(request.getParameter("timeSelected"));
            TreatmentCourseDetailDAO.changeTimeTreatmentCourse(id, date, time);
            Runnable myRunnable = new Runnable() {
                    @Override
                    public void run() {
                        // Các công việc được thực thi trong luồng này
                        SendMail.sendEmail(user.getEmail(), "Mail from Dental Clinic System", "Chào anh/chị,<br>"
                                + "<br>"
                                ...
                                + "<br>" 
                                + "Khách hàng: " + user.getFullName() + "<br>"
                                + "Ngày hẹn: " + date + "<br>"
                                + "Thời gian: " + time + "<br>"
