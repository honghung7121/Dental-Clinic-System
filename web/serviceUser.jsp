                        ...
                        <div class="row g-5">
                            <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.6s">
                                ...
                                <div class="position-relative bg-light rounded-bottom text-center p-4">
                                    <a href="login.jsp"><h5 class="m-0">Nhổ răng khôn</h5></a>
                                </div>
                            </div>
                ...
                <div class="row g-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="col-lg-5 service-item wow zoomIn" data-wow-delay="0.9s">
                        <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-4">
                            ...
                            <h2 class="text-white mb-0">+084 345 6789</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container pt-5">
                <div class="row g-5 pt-4">
                    <div class="col-lg-3 col-md-6">
                        <h3 class="text-white mb-4">Đường dẫn nhanh</h3>
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Trang Chủ</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Về Chúng Tôi</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Dịch vụ của chúng tôi</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Blog mới nhất</a>
                            <a class="text-light" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Liên hệ chúng tôi</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <h3 class="text-white mb-4">Liên kết phổ biến</h3>
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Trang Chủ</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Về Chúng Tôi</a>
                            <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Dịch vụ của chúng tôi</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+084 345 67890</p>
                    </div>
                    <div class="col-lg-3 col-md-6">
