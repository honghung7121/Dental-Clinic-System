                        ...
                        <div class="bg-dark d-flex flex-column p-5" style="height: 300px;">
                            ...
                            <div class="date mb-3" id="date" data-target-input="nearest">
                                <input type="text" class="form-control bg-light border-0 datetimepicker-input"
                                       placeholder="Giờ Đặt Lịch" data-target="#date" data-toggle="datetimepicker"
                                       style="height: 40px;">
                            </div>
                            ...
                            <a class="btn btn-light" href="">Tìm kiếm nha sĩ</a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-5">
                        ...
                        <h5 class="text-uppercase text-primary wow fadeInUp" data-wow-delay="0.3s">Liên hệ chúng tôi qua số điện thoại dưới đây</h5>
