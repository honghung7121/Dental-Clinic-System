                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="departments.html"><i class="fa fa-hospital-o"></i> <span>Phòng Ban</span></a>
                            </li>
                            <li class="submenu">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    ...
                                                    <div class="staff-id">Mã Nhân Viên : DR-0001</div>
                                                    <div class="staff-msg"><a href="chat.html" class="btn btn-primary">Gửi Tin Nhắn</a></div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    <li>
                                                        ...
                                                        <span class="text"><a href="#">${dentistByID.phone}</a></span>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="text">01/12/1985</span>
                                                    </li>
                                                    <li>
