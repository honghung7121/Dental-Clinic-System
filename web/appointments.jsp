...
<html lang="en">
    ...
    <body>
        ...
        <c:set var="isCSKH" value="${role eq 4}" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="dropdown dropdown-action">
                                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="MainController?action=EditDateTimeAppointment&id=${appoint.id}"><i class="fa fa-pencil m-r-5"></i>Chỉnh sửa</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
